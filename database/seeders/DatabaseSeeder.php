...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // =========================================================
        // 1. DATA AKUN ADMIN & PENGATURAN (STATIS)
        // =========================================================
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '
                    <div class="content-text">
                        <p class="mb-4">Secara administratif, Desa Arjosari terbagi menjadi 6 (enam) wilayah Dusun yang masing-masing dipimpin oleh seorang Kepala Dusun (Kasun).</p>
                        ...
                        <ul class="list-group list-group-flush mb-4">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">Kawasan Dataran Rendah <span class="badge bg-primary rounded-pill fs-6">1.081,00 Ha</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">Kawasan Lereng Gunung <span class="badge bg-warning text-dark rounded-pill fs-6">175,00 Ha</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">Kawasan Berbukit-bukit <span class="badge bg-secondary rounded-pill fs-6">105,00 Ha</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">Kawasan Dataran Tinggi / Pegunungan <span class="badge bg-success rounded-pill fs-6">104,00 Ha</span></li>
                        </ul>
                    </div>
                '
            ]
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><p>Sektor pertanian merupakan tulang punggung perekonomian di Desa Arjosari. Masyarakat mengelola lahan tegal/ladang yang luasnya mencapai 574 Ha. Berikut adalah komoditas utama tanaman pangan yang dihasilkan:</p></div>'
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><p>Sektor perkebunan mencakup lahan seluas 267 Ha yang didominasi oleh tanah perkebunan rakyat (103 Ha) dan perorangan (164 Ha). Berikut adalah primadona perekonomian perkebunan di Arjosari:</p></div>'
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><p>Peternakan berkembang sangat baik di Desa Arjosari, didukung oleh ketersediaan pakan dari hasil pertanian warga. Sapi dan kambing menjadi ternak peliharaan mayoritas penduduk.</p></div>'
            ]
        );
                ...
                'content' => '
                    <div class="content-text">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                            ...
                            <div class="mb-4"><div class="d-flex justify-content-between small mb-1"><span>Pembangunan Jalan Makadam (7 Km)</span><span class="fw-bold text-success">100%</span></div><div class="progress" style="height: 8px;"><div class="progress-bar bg-success" style="width: 100%;"></div></div></div>
                            <div class="mb-4"><div class="d-flex justify-content-between small mb-1"><span>Rehabilitasi Jembatan Penghubung</span><span class="fw-bold text-primary">75%</span></div><div class="progress" style="height: 8px;"><div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" style="width: 75%;"></div></div></div>
                        </div>
                    </div>
                '
            ]
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '
                    <div class="content-text">
                        <p class="mb-4">Laporan Anggaran Pendapatan dan Belanja Desa (APBDes) Arjosari.</p>
                        <div class="alert alert-success bg-opacity-10 border-success text-center mb-4 p-4 rounded-4"><h6 class="text-success fw-bold mb-2">Total Anggaran Belanja & Penerimaan</h6><h2 class="fw-bold text-dark mb-0">Rp 1.708.145.626,00</h2></div>
                    </div>
                '
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><p>Informasi khusus mengenai pemanfaatan Dana Desa (DD) yang dialokasikan oleh Pemerintah Pusat.</p></div>'
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><div class="text-center bg-success bg-opacity-10 rounded-4 py-5 mb-4 border border-success border-opacity-25 shadow-sm"><h1 class="display-3 fw-bold text-success mb-2">0.7245</h1><span class="badge bg-success rounded-pill px-4 py-2 fs-6 mb-2">STATUS: DESA MAJU</span><div class="small text-muted mt-2">Tahun Pemutakhiran: 2024</div></div></div>'
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                'title' => 'Indikator IDM',
                'content' => '<div class="content-text"><p>Rincian skor komposit pembentuk Indeks Desa Membangun (IDM) Desa Arjosari.</p></div>'
            ]
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'content' => '<div class="content-text"><p>Riwayat perkembangan status Indeks Desa Membangun dari tahun ke tahun.</p></div>'
            ]
        );
    }
}